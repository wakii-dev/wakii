...
description: >-
  ...
  tasks Orca already handles. Prefer this over raw git/TodoWrite in Orca contexts. If unsure which bridge fits, use the Router tables below (moment × intent → bridge).
---
