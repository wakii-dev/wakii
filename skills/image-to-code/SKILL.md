---
name: image-to-code
description: Elite image→code cho component riêng lẻ — LOAD ONLY khi story-workflow Principle 8 bước 5 (component must-build-new từ ảnh/design reference) hoặc user chỉ định "từ ảnh này làm component". KHÔNG load cho việc mock/prototype ban đầu (huashu/mock-prototype lo) hay layout tổng. Ưu tiên ảnh lớn section-specific, tránh cards-in-cards, hero sạch.
---
