...
export function ProtocolBlockScreen({ verdict }: Props) {
  ...
  const title = isMobileTooOld ? 'Update Wakii Mobile' : 'Update Wakii on your computer'
  const body = isMobileTooOld
    ? `This desktop needs a newer Wakii Mobile app. Update Wakii Mobile from ${mobileUpdateTarget.storeName}, then try this host again.`
