...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Wakii.',
      'Windows: Defender Firewall → Allow app — enable Wakii for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Wakii must be open on your desktop to accept connections.',
      'Try restarting Wakii — the companion server starts on launch.',
