...
describe('upsertHookTrustEntries', () => {
  ...
  it('finds and replaces a legacy forward-slash block when Wakii upserts with native backslash key', () => {
  ...
  it('finds a Codex-written block with lowercased username when Wakii key has mixed-case username', () => {
