...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Wakii Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Wakii Mobile')
  })

  it('labels the restore action explicitly when Wakii Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
