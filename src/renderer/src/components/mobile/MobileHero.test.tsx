...
describe('HeroFlow height', () => {
  ...
  it('shows Relay mint failure with no QR and the beta note', () => {
    ...
    expect(screen.getByText('Wakii Relay is in beta.')).toBeInTheDocument()
  })
  ...
  it('demotes the network address picker to a disclosure on Wakii Relay', async () => {
    const props: React.ComponentProps<typeof MobileHeroPairingStep> = {
      pairQrDataUrl: null,
      pairingUrl: null,
      pairingQrError: false,
  ...
  it('keeps a custom address visible on Wakii Relay', () => {
