  ...
  return (
    <p className="text-xs leading-relaxed text-muted-foreground">
      {translate(
        ...
        'Your system package manager installed Wakii, so update it from there — Wakii cannot install this release itself.'
      )}
    </p>
  )
}
...
export function UpdateAvailableSimpleContent({
  ...
  return (
    <div className="flex flex-col gap-2.5 p-3.5">
      ...
      <p className="text-sm text-muted-foreground">
        {translate('auto.components.UpdateCard.05ad78a6d1', 'Wakii v{{value0}} is ready.', {
          value0: version
        })}
      </p>
      {externallyManaged ? (
