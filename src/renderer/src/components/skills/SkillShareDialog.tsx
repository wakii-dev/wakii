...
function operationError(status: string): string {
  return status === 'reconnect-required'
    ? translate(
        ...
        'Reconnect your Wakii account before sharing.'
      )
    : translate(
        'auto.components.skills.SkillShareDialog.unconfigured',
        'Connect an Wakii Cloud account before sharing.'
      )
}
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Wakii could not send the cancellation request. The upload may still finish.'
        )
      )
    }
  }
