            ...
            {isDesktopWindows ? (
              ...
              >
                <SettingsSwitchRow
                  ...
                  // Why: platform constraint + "close keeps Wakii running" consequence are
                  // both non-obvious from the label alone.
                  description={translate(
                    'auto.components.settings.AppearancePane.b707773a0d',
                    'When enabled, closing the window keeps Wakii running in the system tray instead of quitting.'
                  )}
              ...
              >
                <SettingsSwitchRow
                  ...
                  description={translate(
                    ...
                    'Keep an Wakii shortcut and activity indicator in the macOS menu bar.'
                  )}
