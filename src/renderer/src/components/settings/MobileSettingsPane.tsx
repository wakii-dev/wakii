    ...
    <div className="space-y-4">
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show Wakii Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the Wakii Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Wakii Mobile shortcut in the sidebar.'
          )}
