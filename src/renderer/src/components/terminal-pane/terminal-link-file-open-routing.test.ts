...
describe('handleOscLink', () => {
  it('opens local .html file paths in Wakii browser tabs with the platform modifier', async () => {
  ...
  it('also opens local .htm paths in Wakii browser tabs with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('opens local file paths in Wakii and reveals default column 1 with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('preserves explicit column for Wakii opens from :line:column links', async () => {
    setPlatform('Macintosh')
  ...
  it('falls back to Wakii when shift+cmd/ctrl-click system default open fails', async () => {
    setPlatform('Macintosh')
  ...
  it('ignores stale async completion so latest local click wins for Wakii open and reveal', async () => {
    setPlatform('Macintosh')
