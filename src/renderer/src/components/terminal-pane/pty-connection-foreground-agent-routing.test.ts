...
describe('connectPanePty', () => {
  ...
  it('clears pre-hook launch config when an Wakii-started command exits', async () => {
  ...
  it('confirms an Wakii-launched Droid fresh spawn in a no-OSC shell (Git Bash)', async () => {
