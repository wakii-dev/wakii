...
> = {
  ...
  fork_head_unsupported: {
    ...
    body: {
      ...
      fallback: 'Wakii cannot create a {{reviewLabel}} from this fork head here.'
    }
  },
  base_not_on_remote: {
    title: {
  ...
  unsupported_provider: {
    ...
    body: {
      ...
      fallback: 'This repository provider does not support creating a {{reviewLabel}} from Wakii.'
    }
  }
}
  ...
  if (reason === 'existing_review') {
    ...
    return {
      ...
      description: translate(
        ...
        'Wakii found an existing {{reviewLabel}} for this branch.',
        { reviewLabel }
      ),
      composerMode: 'hidden',
      workflowAction: null,
...
> = {
  ...
  auth_required: {
    ...
    body: {
      ...
      fallback:
        '{{provider}} must be connected in this environment before Wakii can create a {{reviewLabel}}.'
    },
    workflow: null
  }
}
