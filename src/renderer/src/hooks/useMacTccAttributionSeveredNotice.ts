      ...
      try {
        ...
        toast.warning(
          translate(
            ...
            'macOS permissions may not reach Wakii terminals'
          ),
          {
            id: SEVERED_TCC_NOTICE_ID,
            description: translate(
              'auto.hooks.useMacTccAttributionSeveredNotice.description',
              'Running Wakii terminals are hosted by a daemon started by a previous Wakii installation. macOS may not apply Wakii’s Accessibility, Automation, or protected-file permissions to them. Restart the daemon from Manage Sessions to restore access. This will close all running Wakii terminals.'
            ),
            duration: Infinity,
            action: {
              label: translate(
