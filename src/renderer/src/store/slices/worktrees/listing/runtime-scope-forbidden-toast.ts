  ...
  toast.error(
    ...
    ),
    {
      ...
      description: translate(
        ...
        'Workspaces are unavailable on a mobile-scope pairing. Reconnect using the browser access link from Settings → Runtime Environments → Share this Wakii server.'
      )
    }
  )
  return true
